            ...
            <div class="row">
                ...
                <div class="input-group">
                    <div class="col-xs-6 dropdown dropdown-select">
                        <input type="text" id="driver_name" name="driver" value="<?php if (isset($driver)) {
                            echo $driver;
                        } ?>" class="form-control"
                            placeholder="Enter Driver Name" aria-label="search" aria-describedby="search">
                    </div>
                    <div class="col-xs-6 dropdown dropdown-select">
                        <input type="date" id="fromDate" name="fromdate" value="<?php if (isset($from_date)) {
                            echo $from_date;
                        } ?>"
                            class="form-control" placeholder="From Date" aria-label="search" aria-describedby="search">
                    </div>
                    <div class="col-xs-6 dropdown dropdown-select">
                        <input type="date" id="toDate" name="todate" value="<?php if (isset($to_date)) {
                            echo $to_date;
                        } ?>" class="form-control"
                            placeholder="To Date" aria-label="search" aria-describedby="search">
                    </div>
                ...
                <div class="input-group">
                    ...
                    <div class="col-xs-6 dropdown dropdown-select">
                        <input type="text" id="fromSerial" name="fromserial" value="<?php if (isset($fromserial)) {
                            echo $fromserial;
                        } ?>"
                    ...
                    <div class="col-xs-6 dropdown dropdown-select">
                        <input type="text" id="toSerial" name="toserial" value="<?php if (isset($toserial)) {
                            echo $toserial;
                        } ?>"
                ...
                <div class="input-group">
                    ...
                    <div class="col-xs-6 dropdown dropdown-select">
                        <input type="text dropdown dropdown-select" id="search-input" name="code"
                            value="<?php if (isset($code)) {
                                echo $code;
                            } ?>" class="form-control" placeholder="Enter Code" aria-label="search"
                            aria-describedby="search">
                    </div>
                    <div class="col-xs-6 dropdown dropdown-select">
                        <input type="text dropdown dropdown-select" id="search-input-sub" name="sub"
                            value="<?php if (isset($sub)) {
                                echo $sub;
