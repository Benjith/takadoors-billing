              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div style="margin-left:350px;">
                    <a class="btn btn-primary mt-2 mt-xl-0" id="addRowLink">Add New Row</a>    
                  </div>
                </div>
                    ...
                    <table id="orderTable" class="table">
                      ...
                      <tbody>
                        <tr>
                                          ...
                                          <td><textarea class="form-control" name="quantity" rows="1"></textarea></td>
                                           <td><textarea class="form-control" name="design" rows="1"></textarea></td>
                                           <td><textarea class="form-control" name="frame" rows="1"></textarea></td>
                                           <td><textarea class="form-control" name="code" rows="1"></textarea></td>
                                           <td><textarea class="form-control" name="remarks" rows="1"></textarea></td>
...
$(document).ready(function(){
  ...
  function reorderSerialNumbers() {
    ...
    $("#addRowLink").click(function(){
        ...
        var newRow = '<tr><td class="serial-number">1</td><td><textarea class="form-control" name="thickness" rows="1"></textarea></td><td><textarea class="form-control" name="length" rows="1"></textarea></td><td><textarea name="width" class="form-control"  rows="1"></textarea></td><td><textarea class="form-control" name="quantity" rows="1"></textarea></td><td><textarea class="form-control" name="design" rows="1"></textarea></td><td><textarea class="form-control" name="frame" rows="1"></textarea></td><td><textarea class="form-control" name="code" rows="1">'+lastRowCodeValue+'</textarea></td><td><textarea class="form-control" name="remarks" rows="1"></textarea></td><td><a href="#" class="deleteRow"><i class="mdi mdi-delete"></i></a></td></tr>';
